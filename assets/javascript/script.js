$('document').ready(function(){
  ...
  // Events
    ...
    $('.gallery_image').click(function() {
        ...
        $('.modal-username').html('Uploaded: ' + username);
    });
            ...
            success :  function(response)
            {
                var response = JSON.parse(response);
                    ...
                    if (response.status) {
                        ...
                        //Calling function appendComments with image_id from the url
                        appendComments(image_id);

                      //If status errors
                    } else {
                        if(response.errors) {
                            window.location.href = "/codeigniter/images/max_comments_reached";
