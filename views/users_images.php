    ...
    <div class="container">
        <div class="row">
            ...
            <?php foreach($images as $image): ?>
                <div class="col-lg-3 col-sm-4 col-xs-6 gallery_image" data-username="<?= $image['username']; ?>" data-image-id="<?= $image['id']; ?>" ><a description="<?= $image['description']; ?>" title="<?= $image['title']; ?>" href="#"><img class="thumbnail img-responsive" src="<?= base_url() . 'data/images/' . $image['file_name'] . '' . $image['file_ext'] ?>"></a><a href="<?= base_url(); ?>image/<?= $image['id']; ?>/delete">Delete</a></div>
            <?php endforeach; ?>
